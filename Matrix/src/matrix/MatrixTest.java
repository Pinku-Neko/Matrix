...
//		System.out.println(rationalMatrix.toString());
		...
		final GFPrime[][] finiteField3Array2D = new GFPrime[][] {
			{new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 0)},
			{new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 0)},
			{new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 0),new GFPrime(3, 1),new GFPrime(3, 1)},
			{new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 2),new GFPrime(3, 1)},
			{new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 2),new GFPrime(3, 1)},
			{new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 2),new GFPrime(3, 1)}
		};
		...
		final GFPrime[][] finiteField3Array2D2 = new GFPrime[][] {
			{new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 2)},
			{new GFPrime(3, 1),new GFPrime(3, 0),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 2)},
			{new GFPrime(3, 1),new GFPrime(3, 0),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 0)},
			{new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 2),new GFPrime(3, 2)},
			{new GFPrime(3, 1),new GFPrime(3, 1),new GFPrime(3, 0),new GFPrime(3, 2),new GFPrime(3, 1),new GFPrime(3, 2)},
			{new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 0),new GFPrime(3, 1)}
		};
		...
		final GF4[][] finiteField4Array2D = new GF4[][] {
			...
			{new GF4(7),new GF4(1),new GF4(0),new GF4(1)},
