...
/**
 * this is a rational number, contains a numerator and a denominator
 * 
 * the value of a rational number is the quotient of a numerator by a
 * denominator
 * 
 * @author Pinku_Neko
 *
...
public class RationalNumber implements Field<RationalNumber> {
	 ...
	 * 
	 * represents the value a from a rational number [ a / b ]
	 */
	 ...
	 * 
	 * the value of this number can be all integer number EXCEPT 0
	 * 
	 * represents the value b from a rational number [ a / b ]
	 */
	 ...
	 * 
	 * precondition: the numerator is an integer number AND denominator is an
	 * integer number EXCEPT 0
	 * 
	 * postcondition: create a rational number by given numerator and denominator
	 * 
	 ...
	 * 
	 * @return the rational number in the form: [ numerator / denominator ]
	 */
	@Override
	 ...
	 * 
	 * gets an element e which applies the following: x + e = x
	 * 
	 ...
	 * 
	 * gets an element n which applies the following: x * n = x
	 * 
	 ...
	 * 
	 * gets an element x' which applies to the following: x + x' = e
	 * 
	 ...
	 * 
	 * an element x" which applies to the following: x * x" = n
	 * 
	 ...
	 * 
	 * postcondition: the result is [ (1st numerator * 2nd denominator + 2nd
	 * numerator * 1st denominator) / (1st denominator * 2nd denominator) ]
	 * 
	...
	public RationalNumber add(final RationalNumber element) {
		...
		final int newNumerator = this.numerator * element.denominator + element.numerator * this.denominator;
	 ...
	 * precondition: both elements are rational
	 * 
	 * postcondition: the result is [ (1st numerator * 2nd numerator) / (1st
	 * denominator * 2nd denominator) ]
	 * 
	 ...
	 * precondition: both elements are rational
	 * 
	 * postcondition: the result is [ (1st numerator * 2nd denominator) / (1st
	 * denominator * 2nd numerator) ]
	 * 
	...
	/**
	 * FIXME should actually override Object.equals() but failed check if two
	 * elements are same.
	 * 
	 * verify if this element has exact the same value as the given element
	 * 
	 * precondition: the given element is not a null-reference
	 * 
	 * postcondition: if both rational numbers in lowest terms have the same value
	 * of numerator and denominator, returns true, otherwise false
	 * 
	 ...
	 * 
	 * verify if this element has exact the same value as the neutral element for
	 * addition has here [ 0 / 1 ]
	 * 
