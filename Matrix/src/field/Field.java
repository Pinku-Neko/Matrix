...
/**
 * this is an interface of field every field must have defined:
 * 
 * -<E>: what kind of element it is -addition: neutral and inverse elements
 * -multiplication: neutral and inverse elements
 * 
 * and all the calculations including: addition, subtraction, multiplication,
 * division
 * 
 * @author Pinku_Neko
 *
...
public interface Field<E> {
	 ...
	 * 
	 * an element e which applies to the following: x + e = x
	 * 
	 ...
	 * 
	 * an element n which applies to the following: x * n = x
	 * 
	 ...
	 * 
	 * an element x' which applies to the following: x + x' = e
	 * 
	 ...
	 * 
	 * postcondition: the result is CORRECT according to the definition of addition
	 * in this field AND is an element in the SAME field
	 * 
	 ...
	 * precondition: both elements are in the SAME field
	 * 
	 * postcondition: the result is CORRECT according to the definition of
	 * subtraction in this field AND is an element in the SAME field
	 * 
	 ...
	 * 
	 * postcondition: the result is CORRECT according to the definition of
	 * multiplication in this field AND is an element in the SAME field
	 * 
	 ...
	 * precondition: both elements are in the SAME field
	 * 
	 * postcondition: the result is CORRECT according to the definition of division
	 * in this field AND is an element in the SAME field
	 * 
